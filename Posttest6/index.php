    ...
    <header>
        <nav class="nav">
            ...
            <ul class="nav-list">
                ...
                <li class="nav-item"><a href="#catalog" class="nav-link" id="catalog-link">Catalog</a></li>
    ...
    <main>
        ...
        <div class="catalog" id="catalog">
            ...
            <section class="catalog-content">
                <?php $i = 1; foreach($data_roti as $roti): ?>
                    
                <?php
                    echo "<div class='product-card'>
                    <div class='badge'>Hot</div>
                    <div class='product-tumb'>
                        <img src='assets/catalog/{$roti['gambar']}' alt=''>
                    </div>
                    <div class='product-details'>
                        <span class='product-catagory'>Rotiku &copy</span>
                        <h4><a href=''>{$roti['nama']}</a></h4>
                        <p>{$roti['deskripsi']}</p>
                        <div class='product-bottom-details'>
                            <div class='product-price'>Rp.{$roti['harga']}</div>
